...
<script>
    ...
    function __formatValue(payment_type, total) {
        log(total)
    ...
    $('#dataTable tbody').on('click', '#process-with-edit-stock-po', async function () {
        ...
        try{
            ...
            if(status) {
                ...
                elm_final_total_2.innerHTML         = __formatValue(payment_type, order.total_price);
                                                ...
                                                if(status) {
                                                    ...
                                                    for(const order_item of order_items) {
                                                        if(order_item.total_item !== 0) {
                                                            ...
                                                            elm_wrap_order_items_2.insertAdjacentHTML('afterbegin', __elmOrderItemWithUpdateStock(order_item, order_items, ttl_length, id_po, wh_id, order));
                                                        }
                                                    }
    ...
    $('#dataTable').on('click', '#view-order-detail', async function() {
        ...
        try{
            ...
            if(status) {
                ...
                elm_ttl_harga.innerHTML         = __formatValue(payment_type, order.final_total);
                ...
                info_product += `
                    <tr>
                        ...
                        <td valign="top">
                            ...
                            <h6 class="mt-2" style="color:#2A8FCC;"><span style="color:#000;font-size:14px; font-weight:500;margin-right:5px">Harga per-unit : </span> ${__formatValue(payment_type, price_)}</h6>
                        </td>
                    </tr>
                    <tr>
                        <tr>
                    ...
                    <tr>
                        ...
                        <td valign="top">
                            ...
                            <p class="d-flex align-items-center">
                                ...
                                <span style="color:#2A8FCC;"> ${__formatValue(payment_type, price_)}</span>
                            </p>
                        </td>
                    </tr>
                    <tr>
                ...
                <tr>
                    ...
                    <td valign="top">
                        ...
                        <p class="d-flex align-items-center">
                            ...
                            <input type="number" class="form-control  form-control-sm" name="total_stock_order_item[${order_item.id}]" value="${order_item.total_item}" onclick="preventPositiveNumber(${order_item.id}, this, ${JSON.stringify(order_item).replace(/\"/g,"'")}, ${order_id}, ${warehouse_id}, ${JSON.stringify(order).replace(/\"/g,"'")})" onwheel="preventPositiveNumber(${order_item.id}, this, ${JSON.stringify(order_item).replace(/\"/g,"'")}, ${order_id}, ${warehouse_id}, ${JSON.stringify(order).replace(/\"/g,"'")})" onkeyup="changeStock(${JSON.stringify(order_item).replace(/\"/g,"'")}, this, ${order_id}, ${warehouse_id}, , ${JSON.stringify(order).replace(/\"/g,"'")})">
                        </p>
                        <h6 class="mt-2" style="color:#2A8FCC;" id="total_price"><span style="color:#000;font-size:14px; font-weight:500;margin-right:5px">Harga per-unit</span> ${__formatValue(payment_type, order_item.prod_base_price)}</h6>
                    </td>
                </tr>
