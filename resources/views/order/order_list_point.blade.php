...
@section('breadcrumb', 'Dashboard  /  Order Produk Point  /  Order List')
        ...
        <div class="modal-content" style="border:none;">
            ...
            <div class="modal-body">
                <div class="card">
                    ...
                    <div class="card-footer btn btn-gradient" id="print-po-div">
            ...
            columns: [
                {
                    ...
                    render: function(_, __, data){
                        ...
                        // log(data)
                        let status = String(status_po.replace(' ', '-')).toLocaleLowerCase();
                        ...
                        let btn_menuggu_konfirmasi = ( status == obj_status_order.mk) ? `${btn_proses_po} ${btn_edit_po} ${btn_cancel_po}` : ''
                ...
                },
                {
                    ...
                    sClass: 'text-center',
                    render: function(data){
                        let status = data.split(' ').join('-').toLocaleLowerCase();
    ...
    $('#dataTable tbody').on('click', '#process-with-edit-stock-po', async function () {
        ...
        try{
            ...
            if(status) {
                ...
                elm_status_po_2.classList.add(order.status_po.split(' ').join('-').toLocaleLowerCase(), 'btn', 'btn-sm')

                elm_final_total_2.innerHTML         = `Rp ${__toRp(order.total_price)}`;

                elm_alamat_2.innerHTML              = address;
                elm_no_hp_2.innerHTML               = user_profile_phone;
                elm_pembeli_2.innerHTML             = user_full_name;

                elm_ttl_ongkir_2.innerHTML          = `Rp ${__toRp(order.total_ongkir)}`;
                ...
                elm_ttl_ongkir_3.innerHTML          = `Rp ${__toRp(order.total_ongkir)}`
                ...
                for(const order_item of order_items) {
                    if(order_item.total_item !== 0) {
                        ...
                        elm_wrap_order_items_2.insertAdjacentHTML('afterbegin', __elmOrderItemWithUpdateStock(order_item, order_items, ttl_length, id_po, wh_id));
                    }
                }
                                            ...
                                            if(status) {
                                                ...
                                                if(status) {
                                                    ...
                                                    if(result_ongkir.status) {
                                                        ...
                                                        elm_ttl_ongkir_3.innerHTML  = `Rp ${__toRp(result_ongkir?.data?.order?.total_ongkir)}`;
                                                        elm_final_total_2.innerHTML = `Rp ${__toRp(result_ongkir?.data?.order?.total_price)}`;
                                                    } else {
                                                        elm_ttl_ongkir_3.innerHTML  = `Rp ${__toRp(order.total_ongkir)}`;
                                                        elm_final_total_2.innerHTML = `Rp ${__toRp(order.total_price)}`;
                                                    }
...
//eksport data bulk sesuai filter
    ...
    $('#dataTable').on('click', '#view-order-detail', async function() {
        ...
        try{
            ...
            if(status) {
                ...
                elm_status_po.classList.add(order.status_po.split(' ').join('-').toLocaleLowerCase(), 'btn', 'btn-sm')
                ...
                for(const order_item of order_items) {
                    elm_wrap_order_items.insertAdjacentHTML('afterbegin', __elmOrderItem(order_item, order.status_po));
                }
    ...
    function __elmOrderItem(order_item, status_po) {
                ...
                info_product += `
                    <tr>
                        ...
                        <td valign="top">
                            ...
                            <p style="display: inline-block;margin-right:5px;">Jumlah Barang dikirim :  <h6 style="color:#2A8FCC;display: inline-block;">${order_item.total_item_before}</h6> (${__gramToKg(order_item.prod_gram, order_item.total_item)} kg)</p>
                    ...
                    <tr>
                        ...
                        <td valign="top">
                            ...
                            <p class="d-flex align-items-center">
                                ...
                                <span>${order_item.total_item} Barang (${__gramToKg(order_item.prod_gram, order_item.total_item)} kg)</span>
                            </p>
                            <p class="d-flex align-items-center">
                                <span style="width:120px">Harga Per Unit</span>
                                <span style="color:#2A8FCC;">Rp ${__toRp(order_item.prod_base_price)}</span>
                            </p>
                        </td>
                    </tr>
                    <tr>
    ...
    function __elmOrderItemWithUpdateStock(order_item,order_items, length_of_order_items = 0, order_id = null, warehouse_id = null) {
        ...
        if(length_of_order_items > 1) {
            ...
            return `
                ...
                <tr>
                    ...
                    <td valign="top">
                        <h6 style="display:flex;justify-content:space-between;">${order_item.prod_name}
                        ...
                        <p class="d-flex align-items-center">
                            ...
                            <input type="number" class="form-control  form-control-sm" name="total_stock_order_item[${order_item.id}]" value="${order_item.total_item}" onclick="preventPositiveNumber(${order_item.id}, this, ${JSON.stringify(order_item).replace(/\"/g,"'")}, ${order_id}, ${warehouse_id})" onwheel="preventPositiveNumber(${order_item.id}, this, ${JSON.stringify(order_item).replace(/\"/g,"'")}, ${order_id}, ${warehouse_id})" onkeyup="changeStock(${JSON.stringify(order_item).replace(/\"/g,"'")}, this, ${order_id}, ${warehouse_id})">
                        </p>
                        <h6 class="mt-2" style="color:#2A8FCC;" id="total_price"><span style="color:#000;font-size:14px; font-weight:500;margin-right:5px">Harga per-unit</span> Rp ${__toRp(order_item.prod_base_price)}</h6>
                    </td>
                </tr>
            ...
            return `
                ...
                <tr>
                    ...
                    <td valign="top">
                        <h6 style="display:flex;justify-content:space-between;">${order_item.prod_name}</h6>
                        <p class="d-flex align-items-center">
                            <span style="width:155px">Jumlah Pesanan</span>
                            <input type="number" class="form-control  form-control-sm" value="${order_item.total_item}" disabled>
                        </p>
    ...
    async function changeStock(order_item, e, id_po, wh_id) {
        ...
        if(elm_total_item.value > order_item.total_item) {
            ...
            if(data !== '0') {
                ...
                elm_ttl_ongkir_3.innerHTML = `${__toRp(price_ori)}`;
            } else {
                elm_ttl_ongkir_3.innerHTML = `${__toRp(order_total_ongkir.value)}`;
            }
            ...
            elm_final_total_2.innerHTML = `Rp ${__toRp(total_price)}`
    ...
    async function preventPositiveNumber(key,e, order_item, id_po, wh_id) {
