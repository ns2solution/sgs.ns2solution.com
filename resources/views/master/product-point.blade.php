...
@section('title', '| Produk Point')
@section('breadcrumb', 'Dashboard  /  Produk Point /  Produk Point')
...
<button type="button" class="btn btn-primary btn-icon-text px-3 px-lg-4 btn-gradient float"  id="open-modal-product" style="font-size:17px;">
	&nbsp;<i class="link-icon" data-feather="plus-square"></i>&nbsp;
    Tambah Produk Point&nbsp;

</button>

<button type="button" class="btn btn-primary btn-icon-text px-3 px-lg-4 btn-gradient float3" onclick="bulkModal()" style="font-size:17px;right:300px">
    &nbsp;<i class="link-icon" data-feather="plus-square"></i>&nbsp;
    Tambah Bulk Produk Point&nbsp;
		...
		<div class="card">
			<div class="card-header" style="padding:1.35rem 1.5rem 0rem 1.5rem;">
				<div class="d-flex justify-content-between align-items-baseline">
					<h5 class="card-title"> Produk Point </h5>
	      	...
	      	<form class="cmxform" id="form-product" method="get" action="#" enctype="multipart/form-data">
				<fieldset>
                    ...
                    <!-- <div class="form-group">
                        ...
                        <textarea class="form-control" name="prod_description" id="prod_description" rows=6></textarea>
                    </div> -->
					<!-- <div class="form-group">
					...
					<div class="form-group">
						<label>Point</label>
                        <input class="form-control" type="number" style="text-align:left !important;" name="prod_base_point" id="prod-base-point" >
					</div>
					<div class="form-group">
					...
					<div class="modal-footer">
                        ...
                        <button class="btn btn-primary save" type="submit" id="save-product"> Save</button>
					</div>
				</fieldset>
			</form>
    	</div>
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form class="cmxform" id="form-bulk">
                <fieldset>
                    <div class="form-group">
                        <a href="{{ asset('template_product_point.xlsx') }}" target="_blank" type="button" class="btn btn-primary">Download Template BULK</a>
                    </div>
                    <div class="form-group">
                        <input type="file" name="bulk_file"  class="dropify"  data-max-file-size="10M" data-height="150" data-errors-position="outside" id="bulk_file" data-allowed-file-extensions="xls xlsx">
                    </div>
                    <div class="modal-footer">
                        <button class="btn btn-danger" type="button" id="close-upload-bulk"> Close</button>
                        <button class="btn btn-primary" type="submit" id="btn-upload-bulk"> Upload</button>
                    </div>
                </fieldset>
            </form>
        </div>
...
<script>
    ...
    $(document).ready(async function () {
            ...
            //             'imageFormat': 'File tidak sesuai, format ( only).'
            //         }
            //     });
        ...
        let elm_prod_base_point = __getId('prod-base-point')
        ...
        table = $('#data-table').DataTable({
            ...
            order: [[2, 'DESC']],
            ajax:{
                url: "{{ env('API_URL') . '/product-point/data-table' }}",
                dataType: 'JSON',
                type: 'POST',
                data: {
                    _token: '{{ csrf_token() }}',
        ...
        function onProdBasePrice(e) {
            ...
            if(value < 0){
                elm_prod_base_point.value = 0;
            }

            if (new String(e.target.value) > 10) {
                elm_prod_base_point.value = parseInt(new String(e.target.value).slice(0,10).toString())
            }
        }
        ...
        function preventPositiveNumber(type) {
            return function(e) {
                e.preventDefault()
                switch(type) {
                    case 'prod_base_point':
                        if(elm_prod_base_point.value < 0) {
                            elm_prod_base_point.value = 0;
                        }
                    break;
                    case 'prod_gram' :
        ...
        async function saveProduct(e) {
            ...
            formData.append('prod_type_id', 1)
            debugger;
        ...
        */
        ...
        async function openModalProduct() {
            ...
            elm_modal_header.innerHTML = `<h6>Tambah Produk Point</h6>
        ...
        elm_open_modal.addEventListener('click', openModalProduct);

        //elm_prod_base_point.addEventListener('keyup', onProdBasePrice)
        //elm_prod_base_point.addEventListener('click', preventPositiveNumber('prod_base_price'))
        ...
        elm_close_upload_bulk.addEventListener('click', closeModalUploadBulk);
        ...
        $('#data-table tbody').on('click', '#edit-btn', async function () {
            ...
            elm_modal_header.innerHTML = `<h6>Edit Produk Point</h6>
