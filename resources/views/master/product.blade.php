...
<button type="button" class="btn btn-primary btn-icon-text px-3 px-lg-4 btn-gradient float3" onclick="bulkModal()" style="font-size:17px;">
    &nbsp;<i class="link-icon" data-feather="plus-square"></i>&nbsp;
    Tambah Bulk Produk&nbsp;
        ...
        <div class="modal-body">
            <form class="cmxform" id="form-bulk">
                <fieldset>
                    ...
                    <div class="form-group">
                        <input type="file" name="bulk_file"  class="dropify"  data-max-file-size="10M" data-height="150" data-errors-position="outside" id="bulk_file" data-allowed-file-extensions="xls xlsx csv">
                    </div>
                    <div class="modal-footer">
    ...
    $(document).ready(async function () {
        ...
        async function updateProduct(e, id) {
            ...
            try {
                ...
                // }
                $.ajax({
                    url:`{{ env('API_URL') . '/product/update/${id}' }}`,
                    method:"POST",
                    data: formData,
                    dataType:'JSON',
                    contentType: false,
            ...
            .then(async (willDelete) => {
                if (willDelete) {
                    ...
                    try {
                        ...
                        let res = await fetch(`{{ env('API_URL') . '/product/delete/${id}' }}`, Object.assign({}, __propsPOST, {
                            method: 'DELETE'
                        }))
