        ...
        <div class="modal-content" style="border:none;">
            ...
            <form class="cmxform" id="form-buyer" method="get" action="#" enctype="multipart/form-data">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-light" id="close-buyer"> Batal </button>
                    <button type="submit" class="btn btn-primary btn-custom" id="save-buyer"> Simpan </button>
                </div>
            </form>
        </div>
    </div>
...
<script>
    ...
    $(document).ready(async function () {
        ...
        $('#data-table tbody').on('click', '#edit-btn', function () {
            ...
            $('#modal-title').empty().append('Edit Warrior');
